...
public class ListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemList.add(new Item(R.drawable.aaa, "Title01", "Text0101"));
        itemList.add(new Item(R.drawable.aaa, "Title02", "Text0102"));
        itemList.add(new Item(R.drawable.aaa, "Title03", "Text0103"));
        itemList.add(new Item(R.drawable.aaa, "Title04", "Text0104"));
        itemList.add(new Item(R.drawable.aaa, "Title05", "Text0105"));
